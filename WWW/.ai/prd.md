# Dokument wymagań produktu (PRD) – FiszkiNet

## 1. Przegląd produktu
Projekt FiszkiNet ma na celu umożliwienie użytkownikom szybkiego tworzenia i zarządzania zestawami fiszek edukacyjnych. Aplikacja wykorzystuje modele LLM (poprzez API) do generowania sugestii fiszek na podstawie dostarczonego tekstu.

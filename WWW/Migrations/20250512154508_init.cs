        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastReviewDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenerationStatistics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GenerationStatistics_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultStudySessionLength = table.Column<int>(type: "int", nullable: false),
                    DefaultCardsPerSession = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousEaseFactor = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    PreviousInterval = table.Column<int>(type: "int", nullable: false),
                    NewEaseFactor = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    NewInterval = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudySessionDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudySessionDetails_Flashcards_FlashcardId",
                        column: x => x.FlashcardId,
                        principalTable: "Flashcards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudySessionDetails_StudySessions_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_flashcards_created_at",
                table: "Flashcards",
                columns: new[] { "UserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "idx_flashcards_next_review_date",
                table: "Flashcards",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_generation_statistics_generated_at",
                table: "GenerationStatistics",
                columns: new[] { "UserId", "GeneratedAt" });

            migrationBuilder.CreateIndex(
                name: "idx_generation_statistics_user_id",
                table: "GenerationStatistics",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "idx_study_session_details_flashcard_id",
                table: "StudySessionDetails",
                column: "FlashcardId");

            migrationBuilder.CreateIndex(
                name: "idx_study_session_details_session_id",
                table: "StudySessionDetails",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "idx_study_sessions_started_at",
                table: "StudySessions",
